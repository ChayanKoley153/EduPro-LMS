...
const Hero = () => {
    return (
        <div className='bg-slate-800 p-14'>
            <div className='lg:h-[700px] max-w-7xl mx-auto flex md:flex-row flex-col gap-10 items-center'>
                ...
                <div className='space-y-7 px-4 md:px-0'>
                    ...
                    <div className='inline-flex relative'>
                        <input type="text" placeholder='Search Your course Here...' className='bg-gray-200 w-[350px] md:w-[450px] text-gary-800 p-4 pr-40 rounded-lg rounded-r-xl placeholder:text-gray-500' />
                ...
                <div className="flex md:h-[700px] items-end relative px-4 md:px-0">
                    ...
                    <div className="bg-slate-200 hidden md:flex gap-3 items-center rounded-md absolute top-[15%] left-0
                    px-4 py-2">
                        <div className="rounded-full bg-blue-400 p-2 text-white">
                            <Award />
                        </div>
